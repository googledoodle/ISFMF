...
parser.add_argument("-in", "--image_num", type=int,
                    help="num of input images on teh user side", default=2)
...
if do_preprocess:
    ...
    R, D_all, item_ids = data_factory.load(aux_path)
    CNN_X = D_all['X_sequence']
    vocab_size = len(D_all['X_vocab']) + 1
    img_path = "data/clothes/img/"
